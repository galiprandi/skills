...
```bash
node .agents/skills/browser-automation/scripts/browser.js exec find "Compose"    # get fresh ref
node .agents/skills/browser-automation/scripts/browser.js exec click <ref>       # use ref from THIS find
# ref is now stale, get a new one
node .agents/skills/browser-automation/scripts/browser.js exec find "To"         # get fresh ref
node .agents/skills/browser-automation/scripts/browser.js exec fill <ref> "text" # use new ref
```
...
```bash
node .agents/skills/browser-automation/scripts/browser.js exec eval "() => document.querySelector('[data-loaded]') ? 'ready' : 'loading'"
```
